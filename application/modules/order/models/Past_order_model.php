...
class Past_order_model  extends CI_Model {
    //var $table , $column_order, $column_search , $order =  '';
    var $table = ORDERS;
    var $column_order = array('orders.tracking_id', 'orders.service_type', 'orders.service_id','orders.price','orders.created_at','sea.title as sea_title','courier.title as courier_title','order_item.title as air_title','orders.orderID','orders.receipt_file'); //set column field database for datatable orderable
