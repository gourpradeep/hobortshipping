                     ...
                     <div class="boxHeader">
                        <div class="trackingBox">
                           <div class="orderPlaced">
                              ...
                              <h2>Cost of order: </h2>
						    <h2><?php echo !empty($concierge_detail->order_cost)?'$'.$concierge_detail->order_cost:'NA'; ?></h2>
						    <h2>Concierge Fee: </h2>
						    <h2><?php echo !empty($concierge_detail->concierge_fee)?'$'.$concierge_detail->concierge_fee:'NA'; ?></h2>
						     <h2>Total: </h2>
						    <h2><?php echo !empty($concierge_detail->offer_price)?'$'.$concierge_detail->offer_price:'NA'; ?></h2>
						    <p>This price has been given by admin now you can place your order.</p>
						    <div class="buttons" id="buttons1">
						<!-- <a class="button" href="#">Sample button</a> -->
						  <button class="button place-order-btn" id="accept" onclick="accept_concierge(1,'<?php echo $concierge_detail->conciergeQuoteID;?>');">Place Order</button>
						  
					</div>
					<div class="buttons" style="display: none;" id="buttons2">
						<!-- <a class="button" href="#">Sample button</a> -->
						  <button class="button place-order-btn" id="accepts" >Place Order</button>
						  <!-- <button class="button cancel-btn" id="cancels" >Cancel</button> -->
					</div>
