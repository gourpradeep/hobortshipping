...
define('SEA_FREIGHT_SERVICES', 'sea_freight_services');
define('AIR_FREIGHT_SERVICES', 'air_freight_services');
define('AIR_FREIGHT_ITEMS', 'air_freight_items');
define('COURIER_SERVICES', 'courier_services');
define('ORDERS', 'orders');
define('OS', 'order_shipments');
define('AIR_FREIGHT_ORDER_INFO', 'air_freight_order_info');
define('CONCIERGE_QUOTES', 'concierge_quotes');
define('TICKETS', 'tickets');
define('TICKET_COMMENTS', 'ticket_comments');
define('TICKET_COMMENT_ATTACHMENTS', 'ticket_comment_attachments');
define('OPTIONS', 'options');
define('NEWSLETTERS', 'newsletter_subscriptions');
define('INQUIRIES', 'inquiries');


//Title, Site name, Copyright etc
define('SITE_NAME','Hobort Shipping'); //your project name
define('COPYRIGHT','&copy; ' . date('Y') ." ". SITE_NAME .'. All rights reserved.');
define('INFO_EMAIL','info@hobortshipping.com');
